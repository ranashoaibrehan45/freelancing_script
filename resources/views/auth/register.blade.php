            ...
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-12">
                    <div class="row p-0 m-0">
                                ...
                                <div class="custom-content">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <div class="mb-6 text-white-50">
                                            {{__('Lorem ipsum, dolor sit amet consectetur adipisicing elit. Exercitationem et esse in velit deleniti facilis quo, placeat totam aliquam veniam, quis rerum itaque, incidunt sequi quidem magni error est! Provident!')}}
                                        </div>
                        ...
                        <div class="col-md-7 col-lg-7 p-0 mx-auto">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('register') }}" class="mt-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="country_id" id="country_id" class="search-box SumoUnder">
                                    ...
                                    <div class="form-group">
                                        <label class="custom-control custom-checkbox">
                                            ...
                                            <span class="custom-control-label">
                                                {{__('I Agree For')}}<a href="javascript:void(0);" class="font-weight-bold">  {{__('Terms & Conditions.')}}</a>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="form-group text-center mb-3">
                                        <button class="btn btn-primary btn-lg w-100 br-7">{{__('Sign Up')}}</button>
                                    </div>
                                    <div class="form-group fs-12 text-center">
                                        {{__('By Clicking Sign up,Your agree to our ')}}
                                        <a href="javascript:void(0);" class="font-weight-bold">{{__('Terms & Conditions')}}</a> {{__('and have read and acknowledge our')}}  <a href="javascript:void(0);" class="font-weight-bold">{{__('Privacy & Services.')}}</a>
                                    </div>
                                </form>
                            </div>
                        </div>
