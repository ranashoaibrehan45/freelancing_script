            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group  my-5">
                        ...
                        <x-text-input type="text" name="title" value="{{old('title') ?? Auth::user()->freelancer->title ?? ''}}" required autocomplete="title" id="title" @class(['is-invalid' => $errors->has('title')]) placeholder="Software engineer | Javascript | iOS" />
