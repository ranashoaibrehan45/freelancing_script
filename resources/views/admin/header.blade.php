    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="{{route('admin.dashboard')}}">
                <img src="{{url('assets/images/brand/logo.png')}}" class="header-brand-img desktop-lgo" alt="{{config('app.name')}} logo">
                <img src="{{url('assets/images/brand/logo1.png')}}" class="header-brand-img dark-logo" alt="{{config('app.name')}} logo">
                <img src="{{url('assets/images/brand/favicon.png')}}" class="header-brand-img mobile-logo" alt="{{config('app.name')}} logo">
                <img src="{{url('assets/images/brand/favicon1.png')}}" class="header-brand-img darkmobile-logo" alt="{{config('app.name')}} logo">
            </a>
                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown country-selector d-flex">
                                <a href="javascript:void(0);" class="nav-link leading-none" data-bs-toggle="dropdown">
                                    <span class="header-avatar1">
                                        <img src="{{url('assets/images/us_flag.jpg')}}" alt="img" class="me-2 country">
                                        <span class="fs-14 font-weight-semibold"> English</span>
                                    </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
                                    <a class="dropdown-item d-flex" href="profile-1.html">
                                        <img src="{{url('assets/images/germany_flag.jpg')}}" alt="img" class="me-2 country mt-1">
                                        <span class="fs-13"> Germany</span>
                                    </a>
                                    <a class="dropdown-item d-flex" href="search.html">
                                        <img src="{{url('assets/images/italy_flag.jpg')}}" alt="img" class="me-2 country mt-1">
                                        <span class="fs-13"> Italy</span>
                                    </a>
                                    <a class="dropdown-item d-flex" href="chat.html">
                                        <img src="{{url('assets/images/russia_flag.jpg')}}" alt="img" class="me-2 country mt-1">
                                        <span class="fs-13"> Russia</span>
                                    </a>
                                    <a class="dropdown-item d-flex" href="login-1.html">
                                        <img src="{{url('assets/images/spain_flag.jpg')}}" alt="img" class=" me-2 country mt-1">
                                    ...
                                    <div class="header-dropdown-list message-menu">
                                        <a class="dropdown-item border-bottom" href="chat.html">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="{{url('assets/images/users/1.jpg')}}"></span>
                                                </div>
                                        ...
                                        <a class="dropdown-item border-bottom" href="chat.html">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="{{url('assets/images/users/2.jpg')}}"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                        ...
                                        <a class="dropdown-item border-bottom" href="chat.html">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="{{url('assets/images/users/3.jpg')}}"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                        ...
                                        <a class="dropdown-item border-bottom" href="chat.html">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="{{url('assets/images/users/4.jpg')}}"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                        ...
                                        <a class="dropdown-item border-bottom"  href="chat.html">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="{{url('assets/images/users/6.jpg')}}"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                        ...
                                        <a class="dropdown-item" href="chat.html">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="{{url('assets/images/users/7.jpg')}}"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                            ...
                            <div class="dropdown profile-dropdown d-flex">
                                <a href="javascript:void(0);" class="nav-link pe-0 leading-none" data-bs-toggle="dropdown">
                                    <span class="header-avatar1">
                                        <img src="{{url('assets/images/users/2.jpg')}}" alt="img" class="avatar avatar-md brround">
                                    </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
                                    ...
                                    <form method="POST" action="{{ route('logout') }}" class="dropdown-item d-flex">
                                        @csrf
