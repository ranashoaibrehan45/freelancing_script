                            ...
                            <table class="table table-hover card-table table-vcenter text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><img class="avatat avatar-md brround me-2" src="{{url('admin/assets/images/orders/7.jpg')}}" alt="img">Books</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="avatat avatar-md brround me-2" src="{{url('admin/assets/images/orders/5.jpg')}}" alt="img">Sports</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="avatat avatar-md brround me-2" src="{{url('admin/assets/images/orders/6.jpg')}}" alt="img">Accesories</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="avatat avatar-md brround me-2" src="{{url('admin/assets/images/orders/4.jpg')}}" alt="img">Watches</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="avatat avatar-md brround me-2" src="{{url('admin/assets/images/orders/10.jpg')}}" alt="img">speakers</td>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="d-flex">
                                ...
                                <div class="">
                                    <a href="javascript:void(0);" class="font-weight-normal1 mb-1 fs-13">kate william</a>
                        ...
                        <div class="mb-3">
                            <div class="d-flex">
                                ...
                                <div class="">
                                    <a href="javascript:void(0);" class="font-weight-normal1 mb-1 fs-13">Jean Powell</a>
